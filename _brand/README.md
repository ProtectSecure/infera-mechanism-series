...
Everything you need to wire the subscribe form, set up email, and ship the legal/copyright spine of the publication. Domain assumed throughout: **infera.studio**. If your domain is different, find-replace it across these files.
...
4. Sign up for Buttondown, point it at `newsletter@infera.studio`
